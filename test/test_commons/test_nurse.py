...
class TestNurse(unittest.TestCase, Nurse):
    ...
    def test_nurse_initialization(self) -> None:
    ...
    def test_nurse_charge_battery(self) -> None:
    ...
    def test_manhattan_distance_to_owner(self) -> None:
        nurse = Nurse("Nurse", 0, 0, 5, 5)
    ...
    def test_nurse_make_emergency_call(self) -> None:
        nurse = Nurse("Nurse", 0, 0, 5, 5)
        owner = Owner("John", 3, 3)
    ...
    def test_nurse_perform_resuscitation_exercise(self) -> None:
        nurse = Nurse("Nurse", 0, 0, 5, 5)
        owner = Owner("John", 3, 3)
    ...
    def test_nurse_perform_action_on_vital_signs_change(self) -> None:
        nurse = Nurse("Nurse", 0, 0, 5, 5)
        owner = Owner("John", 3, 3)
    ...
    def test_nurse_perform_action_on_vital_signs_change_no_action(self) -> None:
        nurse = Nurse("Nurse", 0, 0, 5, 5)
        owner = Owner("John", 3, 3)
        owner.vital_signs = {"heart_rate": 80, "blood_pressure": 120}
    ...
    def test_nurse_get_battery_status(self) -> None:
        nurse = Nurse("Nurse", 0, 0, 5, 5)
