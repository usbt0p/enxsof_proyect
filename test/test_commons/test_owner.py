...
class TestOwner(unittest.TestCase):
    ...
    def test_owner_initialization(self) -> None:
    ...
    def test_agent_drop_object(self) -> None:
        owner = Owner("John", 0, 0)
        thing = Thing(0, 0, "Item")
    ...
    def test_owner_move_to_coordinates(self) -> None:
    ...
    def test_owner_move_object(self) -> None:
